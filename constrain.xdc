...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets Boton_IBUF];
...
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports { Boton }]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
